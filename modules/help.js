...
const HELP_OVERRIDES = {
 ...
 { name: 'kick <@user> [--threshold N] [--do ban|kick|strip] [--command on|off]', description: 'Protect against unauthorized kicks.' },
 { name: 'webhook <@user> [--threshold N] [--do ban|kick|strip] [--command on|off]', description: 'Protect against webhook abuse.' },
 { name: 'emoji <@user> [--threshold N] [--do ban|kick|strip] [--command on|off]', description: 'Protect against emoji abuse.' },
 { name: 'ban <@user> [--threshold N] [--do ban|kick|strip] [--command on|off]', description: 'Protect against unauthorized bans.' },
 { name: 'channel <@user> [--threshold N] [--do ban|kick|strip] [--command on|off]', description: 'Protect against channel abuse.' },
 { name: 'role <@user> [--threshold N] [--do ban|kick|strip] [--command on|off]', description: 'Protect against role abuse.' },
 { name: 'vanity <@user> [--do ban|kick|strip]', description: 'Protect the server vanity URL.' },
 { name: 'botadd <@user>', description: 'Block unauthorized bot additions.' },
 ...
 { name: 'lockdown <@user>', description: 'Toggle server lockdown during a raid.' },
 { name: 'log #channel', description: 'Set the AntiRaid log channel.' },
 { name: 'massjoin <@user> [--threshold N] [--do ban|kick] [--lock true|false] [--punish true|false]', description: 'Detect mass joins and optionally lock or punish.' },
 { name: 'newaccounts <@user> [--threshold days] [--do ban|kick]', description: 'Block accounts newer than the configured age.' },
 { name: 'age <@user> [--threshold days] [--do ban|kick]', description: 'Alias for newaccounts.' },
 { name: 'avatar <@user> [--do ban|kick]', description: 'Block accounts without a profile avatar.' },
 { name: 'nolinks <@user> [--do ban|kick]', description: 'Block accounts with no linked socials.' },
 { name: 'nospam <@user> [--threshold N] [--do ban|kick]', description: 'Block spam-join patterns.' },
 ...
 { name: 'reset @user', description: "Reset a user's economy data (Guild mode only)." },
 { name: 'mode <guild | global>', description: 'Switch economy mode (Server Owner only).' },
 ],
 },
 economyadmin: {
 category: 'economy',
 helpOnBare: false,
 subcommands: [
 { name: 'add @user', description: 'Add an economy admin (Server Owner only).' },
 { name: 'remove @user', description: 'Remove an economy admin (Server Owner only).' },
 { name: 'list', description: 'List all economy admins.' },
 ],
 },
 economyevents: {
 category: 'economy',
 helpOnBare: false,
 subcommands: [
 { name: 'enable', description: 'Enable automatic economy events.' },
 { name: 'disable', description: 'Disable automatic economy events.' },
 { name: 'channel #channel', description: 'Set the economy events announcement channel.' },
 ],
 },
 musicstats: {
 category: 'music',
...
const HELP_SUPPLEMENTS = [
 // ── VoiceMaster ──
 { name: 'vc', aliases: ['voice'], category: 'voicemaster', description: 'Manage your VoiceMaster-created voice channel.', usage: '.vc <action>', subcommands: ['lock', 'unlock', 'rename <name>', 'limit <0-99>', 'claim', 'info', 'transfer @user', 'kick @user', 'ban @user', 'unban @user', 'mute @user', 'unmute @user', 'delete', 'permit @user'] },
 ...
 { name: 'vc permit', category: 'voicemaster', description: 'Permit a user to join your locked VoiceMaster channel.', usage: '.vc permit @user' },
 ...
 { name: 'voicetime', aliases: ['vt'], category: 'info', description: 'View voice-time statistics (today, week, month, all time).', usage: '.voicetime [@user]' },
 { name: 'messages', aliases: ['msgs'], category: 'info', description: 'View message statistics (today, week, month, all time).', usage: '.messages [@user]' },
 { name: 'streamtime', aliases: ['st'], category: 'info', description: 'View stream-time statistics (today, week, month, all time).', usage: '.streamtime [@user]' },
 { name: 'cameratime', aliases: ['ct'], category: 'info', description: 'View camera-time statistics (today, week, month, all time).', usage: '.cameratime [@user]' },
 ...
 { name: 'daily', aliases: ['dly'], category: 'economy', description: 'Claim your daily reward.', usage: '.daily' },
 { name: 'work', aliases: ['wrk'], category: 'economy', description: 'Work a job for credits.', usage: '.work [job name]' },
 ...
 { name: 'open', category: 'economy', description: 'Open a crate for random rewards.', usage: '.open' },
 { name: 'deposit', aliases: ['dep'], category: 'economy', description: 'Deposit credits to the bank.', usage: '.deposit <amount | all | half | quarter>' },
 { name: 'withdraw', aliases: ['with'], category: 'economy', description: 'Withdraw credits from the bank.', usage: '.withdraw <amount | all | half | quarter>' },
 { name: 'transfer', aliases: ['pay'], category: 'economy', description: 'Transfer credits to another user.', usage: '.transfer @user <amount>' },
 { name: 'circulation', category: 'economy', description: 'View total economy circulation stats.', usage: '.circulation' },
 { name: 'leaderboard', aliases: ['lb'], category: 'economy', description: 'View the economy leaderboard.', usage: '.leaderboard [page]' },
 { name: 'profile', aliases: ['prof'], category: 'economy', description: 'View an economy profile.', usage: '.profile [@user]' },
 { name: 'job', category: 'economy', description: 'Manage economy jobs (Guild mode only).', usage: '.job <action>', subcommands: ['add <name> <min> <max> [description]', 'remove <name>'] },
 { name: 'economy', aliases: ['eco'], category: 'economy', adminOnly: true, description: 'Configure the economy system.', usage: '.economy <action>', subcommands: ['enable', 'disable', 'config', 'reset @user', 'mode <guild | global>'] },
 { name: 'economyadmin', aliases: ['ecoadmin'], category: 'economy', adminOnly: true, description: 'Manage economy admins (Server Owner only).', usage: '.economyadmin <action>', subcommands: ['add @user', 'remove @user', 'list'] },
 { name: 'economyevents', aliases: ['ecoevents', 'ecoev'], category: 'economy', adminOnly: true, description: 'Manage economy events settings.', usage: '.economyevents <action>', subcommands: ['enable', 'disable', 'channel #channel'] },
 { name: 'coinflip', aliases: ['cf', 'coin'], category: 'economy', description: 'Flip a coin and bet on the outcome.', usage: '.coinflip <amount> <heads | tails>' },
 { name: 'crash', category: 'economy', description: 'Play crash — cash out before it crashes.', usage: '.crash <amount>' },
 { name: 'gamble', aliases: ['bet'], category: 'economy', description: 'Gamble your credits (50/50 or random multiplier).', usage: '.gamble <amount>' },
 { name: 'scratch', category: 'economy', description: 'Play a scratch card.', usage: '.scratch <amount>' },
 { name: 'roulette', category: 'economy', description: 'Play roulette.', usage: '.roulette <amount> <red | black | green | number>' },
 { name: 'plinko', category: 'economy', description: 'Play plinko.', usage: '.plinko <amount>' },
 { name: 'highlow', aliases: ['hl'], category: 'economy', description: 'Play high-low.', usage: '.highlow <amount>' },
 { name: 'ladder', category: 'economy', description: 'Climb the ladder — risk it for higher multipliers.', usage: '.ladder <amount>' },
 { name: 'dice', category: 'economy', description: 'Roll dice against the bot.', usage: '.dice <amount>' },
 { name: 'slots', aliases: ['sl'], category: 'economy', description: 'Play slots.', usage: '.slots <amount>' },
 { name: 'blackjack', aliases: ['bj'], category: 'economy', description: 'Play blackjack.', usage: '.blackjack <amount>' },
 { name: 'mines', aliases: ['mn'], category: 'economy', description: 'Play mines — find gems, avoid bombs.', usage: '.mines <amount> <bombs>' },
 { name: 'shop', aliases: ['sh'], category: 'economy', description: 'View the economy shop (Guild mode only).', usage: '.shop [add | remove | buy]', subcommands: ['add <name> <price> [@role] [description]', 'remove <name>', 'buy <item name>'] },
 { name: 'event', category: 'economy', adminOnly: true, description: 'Manage server-wide economy events.', usage: '.event <start | stop | list> [type]', subcommands: ['start <type>', 'stop [type]', 'list'] },
 { name: 'buy', category: 'economy', description: 'Buy a shop item.', usage: '.buy <item name>' },
 { name: 'inventory', aliases: ['inv'], category: 'economy', description: 'View your inventory.', usage: '.inventory [@user]' },
 { name: 'use', category: 'economy', description: 'Use an inventory item.', usage: '.use <item name>' },

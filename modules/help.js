...
const HELP_SUPPLEMENTS = [
  ...
  { name: 'voicetime', aliases: ['vt'], category: 'info', description: 'View voice-time statistics.', usage: '.voicetime [@user]' },
  { name: 'messages', aliases: ['msgs'], category: 'info', description: 'View message statistics.', usage: '.messages [@user]' },
  { name: 'streamtime', aliases: ['st'], category: 'info', description: 'View stream-time statistics.', usage: '.streamtime [@user]' },
  { name: 'cameratime', aliases: ['ct'], category: 'info', description: 'View camera-time statistics.', usage: '.cameratime [@user]' },

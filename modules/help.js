...
const HELP_OVERRIDES = {
  ...
  economy: {
    ...
    subcommands: [
      ...
      { name: 'preset <name>', description: 'Apply a preset (standard, highroller, casual, casino).' },
      { name: 'reset @user', description: "Reset a user's economy data." },
      { name: 'mode <guild | global>', description: 'Switch economy mode.' },
...
const HELP_SUPPLEMENTS = [
  ...
  { name: 'work', aliases: ['wrk'], category: 'economy', description: 'Work for credits.', usage: '.work [job name]' },
  ...
  { name: 'job', category: 'economy', description: 'Manage economy jobs.', usage: '.job <action>', subcommands: ['add <name> <min> <max> [description]', 'remove <name>'] },
  { name: 'give', category: 'economy', adminOnly: true, description: 'Give credits to a user (Admin).', usage: '.give @user <amount>' },
  { name: 'take', category: 'economy', adminOnly: true, description: 'Take credits from a user (Admin).', usage: '.take @user <amount>' },
  { name: 'reset', category: 'economy', adminOnly: true, description: "Reset a user's economy data (Admin).", usage: '.reset @user' },
  { name: 'destroy', category: 'economy', adminOnly: true, description: 'Destroy credits from circulation (Admin).', usage: '.destroy <amount>' },
  { name: 'economy', aliases: ['eco'], category: 'economy', adminOnly: true, description: 'Configure the economy system.', usage: '.economy <action>', subcommands: ['enable', 'disable', 'config', 'preset <name>', 'reset @user', 'mode <guild | global>', 'leaderboard'] },
  ...
  { name: 'gamble', aliases: ['bet'], category: 'economy', description: 'Gamble your credits (50/50 or random multiplier).', usage: '.gamble <amount> [heads | tails]' },
  { name: 'bombs', category: 'economy', description: 'Play minesweeper — avoid the bombs.', usage: '.bombs <amount>' },
  { name: 'scratch', category: 'economy', description: 'Play a scratch card.', usage: '.scratch <amount>' },
  { name: 'roulette', category: 'economy', description: 'Play roulette.', usage: '.roulette <red | black | green | odd | even> <amount>' },
  ...
  { name: 'mines', aliases: ['mn'], category: 'economy', description: 'Play mines — find gems, avoid bombs.', usage: '.mines <amount>' },
  { name: 'rob', aliases: ['steal'], category: 'economy', description: 'Attempt to rob another user.', usage: '.rob @user' },
  { name: 'shop', aliases: ['sh'], category: 'economy', description: 'View the economy shop or manage its items.', usage: '.shop [add | remove | buy]', subcommands: ['add <name> <price> [@role] [description]', 'remove <name>', 'buy <item name>'] },
